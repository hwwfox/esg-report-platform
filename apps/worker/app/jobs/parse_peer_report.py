...
def build_mock_parse_result(peer_report_id: str) -> PeerReportParseResult:
    return PeerReportParseResult(
        ...
        topics=[{"peer_report_id": peer_report_id, "extracted_topic_name": "温室气体排放", "confidence": 0.75}],
        metrics=[{"peer_report_id": peer_report_id, "extracted_metric_name": "范围一温室气体排放量", "confidence": 0.72}],
        cases=[],
    )
...
def mark_job_succeeded(db, *, tenant_id: str, job_id: str, result: PeerReportParseResult) -> None:
